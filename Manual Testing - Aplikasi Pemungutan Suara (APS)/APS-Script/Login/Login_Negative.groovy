...
//input username
WebUI.setText(findTestObject('Object Repository/APS/Page_APS_LOGIN/input_Username_username'), "candidaet")
...
WebUI.click(findTestObject('Object Repository/APS/Page_APS_LOGIN/button_Masuk'))
	...
	username = WebUI.verifyMatch("candidaet", "candidat", false)
