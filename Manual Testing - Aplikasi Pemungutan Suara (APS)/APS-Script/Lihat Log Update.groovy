...
//click log update data Test Dung
WebUI.scrollToPosition(60, 30)
WebUI.click(findTestObject('Object Repository/APS/Page_APS_Log Update/i_PEMILIH_icon fas fa-history'))

//click close log update
WebUI.click(findTestObject('Object Repository/APS/Page_APS_Log Update/i_Log Update_ki ki-close'))
